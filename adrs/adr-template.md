# ADR Template — Markdown Architectural Decision Records (MADR)

Use this template to record any architecturally significant decision in this project.
...
_Template source: [adr/madr](https://github.com/adr/madr) v4.0.0 — [MADR Primer](https://ozimmer.ch/practices/2022/11/22/MADRTemplatePrimer.html)_
